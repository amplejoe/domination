...
public class MapRendererTest extends TestCase {
    ...
    public void testGetFirstLines() {
        ...
        String expected1 = "hello string";
        String expected2 = "hello string...";

        assertEquals(expected1,MapRenderer.getFirstLines(test1, 1));
        assertEquals(expected2,MapRenderer.getFirstLines(test2, 1));
        assertEquals(expected2,MapRenderer.getFirstLines(test3, 1));
        assertEquals(expected2,MapRenderer.getFirstLines(test4, 1));
        assertEquals(expected2,MapRenderer.getFirstLines(test5, 1));
